...
serve(async (req) => {
  ...
  try {
    ...
    const attachmentFilename =
        String(body?.attachment?.filename ?? "").trim() || "estimate.pdf";
    ...
    const introText = messageText ||
        "Please review the attached estimate. If you have any questions, simply reply to this email.";
    ...
    const detailRows = [
      clientName
          ...
          : "",
      estimateId
          ? infoRow("Estimate ID", escapeHtml(estimateId))
          : "",
      infoRow(
          "Document",
          attachmentPath
...
<html style="margin:0;padding:0;background:#0B0D12;">
  <body style="margin:0;padding:0;background:#0B0D12;font-family:Arial,Helvetica,sans-serif;">
            ...
            <tr>
              <td style="padding:18px;">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    ...
                    <td align="right" valign="middle">
                      <span style="display:inline-block;padding:7px 12px;border-radius:999px;background:rgba(91,140,255,0.10);border:1px solid #5B8CFF;color:#8FB1FF;font-size:11px;font-weight:900;letter-spacing:0.4px;white-space:nowrap;">
                        ESTIMATE
                      </span>
                    </td>
                  </tr>
                ...
                <div style="color:rgba(183,188,203,0.85);font-size:14px;line-height:22px;text-align:center;font-weight:700;">
                  Your estimate is ready. Please find the PDF attached below.
                </div>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    ...
                    <td width="220" style="height:2px;background:#5B8CFF;font-size:0;line-height:0;">&nbsp;</td>
                    <td style="height:2px;background:transparent;"></td>
                  </tr>
                </table>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                       style="width:100%;background:rgba(10,17,37,0.72);border:1px solid rgba(91,140,255,0.22);border-radius:18px;border-collapse:separate;border-spacing:0;">
                  <tr>
                  ...
                  <tr>
                    <td style="padding:14px 16px;">
                      ...
                      <div style="color:rgba(183,188,203,0.78);font-size:13px;line-height:20px;font-weight:700;">
                        ${escapeHtml(companyName)}${contactLines ? ` • ${contactLines}` : ""}
                      </div>
                    </td>
                  </tr>
                </table>
    ...
    const resendBody: Record<string, unknown> = {
      ...
      subject,
      html,
      text: messageText || "Please review the attached estimate.",
    };
