...
class _CalendarTone {
  static const Color sheetTop = Color(0xFF2A2D31);
  static const Color sheetMid = Color(0xFF1D2024);
  static const Color sheetBottom = Color(0xFF14171B);

  static const Color cardTop = Color(0xFF31353A);
  static const Color cardMid = Color(0xFF23272C);
  static const Color cardBottom = Color(0xFF181B20);

  static const Color innerTop = Color(0xFF2B2F34);
  static const Color innerBottom = Color(0xFF1C2025);

  static const Color chipTop = Color(0xFF34383D);
  static const Color chipBottom = Color(0xFF25292E);

  static const Color edgeTop = Color(0xFF4B4F55);
  static const Color edgeBottom = Color(0xFF373B41);

  static const Color textMain = Color(0xFFF3F4F6);
  static const Color textSoft = Color(0xFFB7BDC6);
  static const Color textMute = Color(0xFF8F97A3);

  static const Color accentGrey = Color(0xFFD8DDE4);
  static const Color activeGrey = Color(0xFF9098A4);
}
...
class _WorkerRangeCalendarSheetState extends State<_WorkerRangeCalendarSheet> {
  ...
  Widget build(BuildContext context) {
    final accent = widget.isPayments
        ? _CalendarTone.accentGrey
        : Colors.orangeAccent;
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                ...
                colors: [
                  _CalendarTone.sheetTop,
                  _CalendarTone.sheetMid,
                  _CalendarTone.sheetBottom,
                ],
              ),
              borderRadius: BorderRadius.circular(30),
              border: Border.all(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(
                              ...
                              colors: [
                                _CalendarTone.cardTop,
                                _CalendarTone.cardMid,
                                _CalendarTone.cardBottom,
                              ],
                            ),
                                        ...
                                        return FadeTransition(
                                          ...
                                          child: SlideTransition(
                                            position: Tween<Offset>(
                                              begin: Offset(_monthDirection.toDouble() * 0.20, 0),
                                              end: Offset.zero,
                                            ).animate(curved),
                                            child: child,
                                          ),
                                ...
                                transitionBuilder: (child, animation) {
                                  ...
                                  return ClipRect(
                                    child: FadeTransition(
                                      ...
                                      child: SlideTransition(
                                        position: Tween<Offset>(
                                          begin: Offset(_monthDirection.toDouble() * 0.12, 0),
                                          end: Offset.zero,
                                        ).animate(curved),
                                        child: child,
                                      ),
                        ...
                        Wrap(
                          ...
                          children: const [
                            ...
                            _LegendItem(
                              color: _CalendarTone.activeGrey,
                              label: 'Active',
                            ),
                            _LegendMixedItem(
                              label: 'Mixed',
...
class _CalendarDayCell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bg = isEdge
      ...
      colors: [
        _CalendarTone.edgeTop,
        _CalendarTone.edgeBottom,
      ],
    )
        : isInRange
        ? LinearGradient(
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Ink(
          decoration: BoxDecoration(
            gradient: bg,
            color: bg == null ? Colors.white.withValues(alpha: 0.025) : null,
            borderRadius: BorderRadius.circular(18),
              ...
              if (count > 0)
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0xFF555A63).withValues(alpha: 0.86),
                      borderRadius: BorderRadius.circular(999),
                      border: Border.all(
  ...
  Widget build(BuildContext context) {
    switch (state) {
      ...
      case WorkerCalendarDayState.active:
        return _dot(_CalendarTone.activeGrey);
