                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        ...
                        colors: [
                          _TaskPalette.cardTop.withOpacity(0.98),
                          _TaskPalette.cardBottom.withOpacity(0.97),
                      ...
                      child: Column(
                        ...
                        children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      PopupMenuButton<String>(
                                        ...
                                        onSelected: (v) => setSheetState(() => status = v),
                                        itemBuilder: (_) => [
                                          _statusMenuItem(
                                            value: 'todo',
                                            label: 'Todo',
                                ...
                                StreamBuilder<List<Map<String, dynamic>>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    final doneCount = subtasks.where((e) {
                                      ...
                                      return localSubtaskState[subtaskId] ?? (e['is_done'] == true);
                                    }).length;
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        ...
                                        ...List.generate(subtasks.length, (index) {
                                          ...
                                          final isDone =
                                              localSubtaskState[subtaskId] ?? (item['is_done'] == true);
                                                  ...
                                                  try {
                                                    ...
                                                    try {
                                                      await TaskService.updateWorkerTask(
                                                        taskId: taskId,
                                                        status: _s(task['status']).isEmpty
                                                            ? 'todo'
                                                            : _s(task['status']),
                                                        workerNote: _s(task['worker_note']),
                                                      );
                                                    } catch (_) {}
                          ...
                          IgnorePointer(
                            ignoring: isDoneNow(),
                            child: Opacity(
                              opacity: isDoneNow() ? 0.55 : 1,
                              child: _TaskInput(
                                controller: noteCtrl,
                                hint: isDoneNow() ? 'Task is completed' : 'Worker note',
                                maxLines: 5,
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            borderRadius: BorderRadius.circular(16),
                                            border: Border.all(
                                              color: accent.withOpacity(role.isEmpty ? 0.08 : 0.22),
                                            ),
                                          ),
                                          child: Row(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              child: Row(
                                children: [
                                  _MediaCapsuleAction(
                                    ...
                                    onTap: isDoneNow() ? null : () => _addTaskImageFromGallery(taskId),
                                  ),
                                  const SizedBox(width: 10),
                                  _MediaCapsuleAction(
                                    label: 'Camera',
                                    ...
                                    iconColor: Colors.white,
                                    onTap: isDoneNow() ? null : () => _addTaskImageFromCamera(taskId),
                                  ),
                                  const SizedBox(width: 10),
                                  _MediaCapsuleAction(
                                    label: 'Attach',
                                    ...
                                    onTap: isDoneNow() ? null : () => _addTaskFile(taskId),
                                  ),
                                ],
                              ),
                            ),
                          ...
                          return Padding(
                            ...
                            child: _TaskDaySection(
                              ...
                              children: List.generate(group.tasks.length, (taskIndex) {
                                ...
                                return _WorkerTaskCard(
                                  task: task,
                                  statusColor: _statusColor(_s(task['status']).toLowerCase()),
                                  priorityColor: _priorityColor(_s(task['priority']).toLowerCase()),
                                  onTap: () => _openTaskActions(task),
                                  alternate: taskIndex.isOdd,
...
class _TasksBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        Container(color: _TaskPalette.bg),
        Positioned(
          top: -70,
          left: -60,
          child: Container(
        ...
        Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              color: Colors.blueAccent.withOpacity(0.035),
            ),
          ),
        ),
      ],
...
class _WorkerTaskCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final title = _s(task['title']).isEmpty ? 'Task' : _s(task['title']);
    final rawDescription = _s(task['description']);
    final cleanDescription =
        TaskService.stripChecklistFromDescription(rawDescription);
    final statusRaw = _s(task['status']).toLowerCase();
    final priorityRaw = _s(task['priority']).toLowerCase();
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        ...
                        colors: [
                          Colors.transparent,
                          const Color(0xFF131923).withOpacity(0.18),
                          const Color(0xFF0D121A).withOpacity(0.46),
                          const Color(0xFF131923).withOpacity(0.18),
                          Colors.transparent,
                        ],
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Icon(
                                  _priorityIcon(priorityRaw),
                                  size: 14,
                                  color: priorityColor,
                                ),
                                const SizedBox(width: 6),
                                Text(
                                  _priorityLabel(priorityRaw),
                                  style: TextStyle(
                                    color: priorityColor,
                                    fontWeight: FontWeight.w800,
                                    fontSize: 12.4,
              ...
              const SizedBox(height: 12),
              _TaskAttachmentsPreview(taskId: _s(task['id'])),
            ],
          ),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        final hasMore = subtasks.length > visible.length;
        ...
        final content = Column(
          ...
          children: [
            ...
            ...List.generate(visible.length, (index) {
              ...
              return Padding(
                padding: EdgeInsets.only(
                  bottom: index == visible.length - 1 && !hasMore ? 0 : 8,
                ),
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
            ...
            if (hasMore) ...[
              const SizedBox(height: 2),
              Text(
                '+${subtasks.length - visible.length} more',
                style: TextStyle(
                  color: Colors.white.withOpacity(0.42),
                  fontWeight: FontWeight.w800,
                  fontSize: 11.4,
